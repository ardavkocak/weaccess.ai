...
urlpatterns = [
    ...
    path("gorev-takibi/ayarlar/genel/", views.GeneralSettingsView.as_view(), name="settings_general"),
    path("gorev-takibi/test/", views.TestActionsView.as_view(), name="test_actions"),
