...
async function handleInteraction(interaction) {
  ...
  //    T1/T2 burada işaretlenir: T1 = çağrı anı, T2 = başarıyla dönüş anı.
  //    İkisi arasındaki fark SADECE Discord'a giden HTTP çağrısının süresidir —
  //    hiçbir SQL/iş mantığı bu iki işaret arasında ÇALIŞMAZ (yukarıdaki
  //    mimari kuralın ölçülebilir kanıtı budur).
  try {
    ilog.mark('T1');
